...
public class BaseTest {
	...
	public void click(String locatorKey) {
	    ...
	    try {
	        ...
	        System.out.println("Clicking on an Element : " + locatorKey);
	         log.info("Clicking on an Element : " + locatorKey);
	         ExtentListeners.getExtent().info("Clicking on an Element : " + locatorKey);

	    } catch (Throwable t) {

	        System.out.println("Error while clicking on an Element : " + locatorKey 
	                           + " | " + t.getMessage());
	...
	public void hover(String locatorKey) {
	    try {
	        getPage().locator(OR.getProperty(locatorKey)).hover();
	        log.info("Hovering on Element : " + locatorKey);
	    } catch (Throwable t) {
	        log.error("Error while hovering on Element : " + locatorKey + " " + t.getMessage());
	        Assert.fail(t.getMessage());
	    }
	}
